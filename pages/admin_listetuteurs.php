                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo    '<tr> 
                                ...
                                <td> ' .$row["email"].'</td>
                                <td>
                                    <form method="POST" enctype="multipart/form-data" action="modification_listetuteurs.php?id='.$row['id_user'].'">
                                    <input class="btn-sm btn-primary" type="submit" value="Modifier" name="" >
                                    </form>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-primary modalBtn" onclick= supTut("'.$row['id_user'].'") data-toggle="modal" data-target="#supmodal">
                                    Supprimer
                                    </button>
                                </td>
                                </tr>';
                        ...
                        echo '<div class="alert alert-primary" role="alert"> Aucun résultats trouvés</div>';
                      }
                      $conn->close();
                    ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p> Voulez vous supprimer le tuteur ? 
                        <p>
                    </div>
